...
*Why both:* They diverge during VT switch—actual focus is cleared but logical focus preserved for restore. Also needed: IPC uses IDs, Smithay API uses WlSurface.
